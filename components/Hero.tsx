...
const Hero: React.FC = () => {
  return (
    <section id="home" className="relative min-h-[100dvh] flex flex-col justify-center px-4 pt-24 pb-12 overflow-hidden bg-transparent">
      {/* Background Depth Accent - Very slow parallax */}
      <div 
        className="absolute top-1/4 left-1/4 w-[260px] md:w-[400px] h-[260px] md:h-[400px] bg-primary/5 rounded-full blur-[60px] md:blur-[80px] pointer-events-none z-0 parallax-layer" 
        style={{ '--speed': '0.02' } as React.CSSProperties}
      />
      
      <ScrollReveal direction="fade-slow" className="max-w-6xl mx-auto w-full relative z-20">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div className="space-y-10 md:space-y-12">
            <ScrollReveal direction="down" delay={200}>
              <div className="inline-flex items-center gap-3 px-4 md:px-5 py-2.5 rounded-full border border-primary/30 bg-primary/20 text-[9px] md:text-xs font-black tracking-[0.2em] md:tracking-[0.3em] uppercase text-indigo-200">
            ...
            <div className="space-y-4 md:space-y-6">
              <ScrollReveal direction="up" delay={400}>
                <h1 className="text-4xl sm:text-6xl md:text-8xl lg:text-[9rem] font-display font-bold leading-[0.9] md:leading-[0.85] tracking-tighter text-white select-none">
                  {/* Word: Infinite */}
              ...
              <ScrollReveal direction="up" delay={600}>
                <p className="text-slate-200 leading-relaxed text-base md:text-lg lg:text-xl font-light max-w-2xl drop-shadow-sm">
            ...
            <ScrollReveal direction="up" delay={800} className="flex flex-col sm:flex-row gap-4 md:gap-6 pt-4 md:pt-8">
              <a href="#contact" className="relative group px-8 md:px-10 py-4 md:py-5 min-h-[44px] rounded-full bg-primary text-white font-bold tracking-[0.2em] md:tracking-[0.3em] text-[10px] md:text-xs uppercase overflow-hidden transition-all hover:scale-105 active:scale-95 shadow-[0_14px_40px_-12px_rgba(99,102,241,0.4)] text-center">
              ...
              <a href="#work" className="px-8 md:px-10 py-4 md:py-5 min-h-[44px] rounded-full border border-white/20 text-white font-bold tracking-[0.2em] md:tracking-[0.3em] text-[10px] md:text-xs uppercase hover:bg-white/10 transition-all backdrop-blur-md group text-center">
          ...
          <ScrollReveal direction="up" delay={1000} className="relative hidden lg:flex justify-end">
            <div 
              className="relative w-full max-w-sm glass-card p-1 rounded-[3rem] shadow-[0_25px_60px_-30px_rgba(0,0,0,0.7)] transition-transform duration-500 ease-out border-white/10 reactive-glass parallax-layer" 
              style={{ '--speed': '0.1' } as React.CSSProperties}
            >
